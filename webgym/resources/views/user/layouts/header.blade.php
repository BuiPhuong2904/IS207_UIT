        ...
        <div class="hidden md:flex items-center gap-4">
            ...
            @auth
                ...
                <a href="{{ route('checkout') }}" class="relative w-10 h-10 flex items-center justify-center bg-gray-100 rounded-full shadow-sm hover:bg-gray-200 focus:outline-none transition-colors">
                    ...
                    @auth
                        <span id="cart-badge" class="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-blue-600 rounded-full border-2 border-white">
                            {{ $cartCount ?? 0 }}
                        </span>
                    @else
                        <span id="cart-badge" class="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-blue-600 rounded-full border-2 border-white">
