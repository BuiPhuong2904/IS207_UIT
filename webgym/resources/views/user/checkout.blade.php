...
<?php
// Hàm tính toán tổng tiền - Giữ nguyên, nhưng dùng $cart_items và $promotions_data từ controller
...
// Tính toán lần đầu khi tải trang (không có mã) - Dùng biến từ controller
...
// Chuẩn bị dữ liệu cho JavaScript - Dùng biến từ controller
