        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl transform transition-all relative flex flex-col max-h-[90vh] overflow-hidden" onclick="event.stopPropagation()">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar p-8 pt-4 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-3 pl-1">
                        <div class="flex items-center">
                            <label class="w-24 text-gray-800 font-medium text-sm">Code</label>
                            <input type="text" id="modal-order-code" readonly
                                class="flex-1 px-4 py-1.5 bg-[#D9D9D94D] border border-[#99999980] rounded-lg text-[#333333] font-semibold focus:outline-none">
                        </div>
                        <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <label class="w-24 text-gray-800 font-medium text-sm">Mã giảm</label>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <div class="space-y-3 pl-1">
                        <div class="flex items-center">
                            <label class="w-24 text-gray-800 font-medium text-sm">Tên</label>
                            <input type="text" id="modal-customer-name" readonly 
                                class="flex-1 px-4 py-1.5 bg-[#D9D9D94D] border border-[#99999980] rounded-lg text-[#333333] font-semibold focus:outline-none uppercase">
                        </div>
                        <div class="flex items-center">
                            <label class="w-24 text-gray-800 font-medium text-sm">SĐT</label>
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" id="modal-address"
                                class="flex-1 px-4 py-1.5 bg-white border border-[#99999980] rounded-lg text-[#333333] font-semibold focus:outline-none">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <div class="flex items-center mt-4">
                        ...
                        <div class="relative w-full sm:w-48">
                            <select id="modal-status-select" class="w-full pl-4 pr-8 py-1.5 bg-white border border-gray-300 rounded-lg text-gray-800 font-medium appearance-none shadow-sm">
            ...
            <div class="flex-none flex justify-center items-center gap-4 px-8 pb-8 pt-4 border-t border-gray-100 bg-white">
                ...
                <button type="button" onclick="alert('Lưu thông tin thành công!')" 
