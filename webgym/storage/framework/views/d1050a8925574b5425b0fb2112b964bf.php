    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            <div class="md:col-span-3">
                ...
                <nav class="space-y-2">
                    <a href="<?php echo e(url('/profile')); ?>" class="bg-blue-100 text-blue-700 group flex items-center px-4 py-3 text-sm font-medium rounded-lg">
            ...
            <div class="md:col-span-9">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mb-6 flex flex-col sm:flex-row items-center justify-between">
                    <div class="flex items-center mb-4 sm:mb-0">
                        <div class="h-16 w-16 bg-gray-200 rounded-full flex-shrink-0 overflow-hidden">
                            <img src="<?php echo e(Auth::user()->image_url ?? 'https://via.placeholder.com/150'); ?>" class="h-full w-full object-cover" alt="Avatar">
                        </div>
                        <div class="ml-4">
                            <h3 class="text-lg font-bold text-gray-900"><?php echo e(Auth::user()->full_name ?? 'Tên người dùng'); ?></h3>
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
                    ...
                    <?php if(session('success')): ?>
                        <div class="bg-green-50 text-green-700 px-4 py-3 rounded mb-6 border-l-4 border-green-500"><?php echo e(session('success')); ?></div>
                    <?php endif; ?>
                    ...
                    <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="full_name" id="full_name" value="<?php echo e(Auth::user()->full_name); ?>" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border">
                            </div>
                            <div>
                                <label for="birth_date" class="block text-sm font-medium text-gray-700 mb-1">Ngày sinh</label>
                                <input type="date" name="birth_date" id="birth_date" value="<?php echo e(Auth::user()->birth_date); ?>" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border text-gray-500">
                            </div>
                            <div>
                                ...
                                <select name="gender" id="gender" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border text-gray-500">
                                    ...
                                    <option value="Nam" <?php echo e(Auth::user()->gender === 'Nam' ? 'selected' : ''); ?>>Nam</option>
                                    <option value="Nữ" <?php echo e(Auth::user()->gender === 'Nữ' ? 'selected' : ''); ?>>Nữ</option>
                                    <option value="Khác" <?php echo e(Auth::user()->gender === 'Khác' ? 'selected' : ''); ?>>Khác</option>
                                </select>
                            </div>
                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">Số điện thoại</label>
                                <input type="tel" name="phone" id="phone" value="<?php echo e(Auth::user()->phone); ?>" placeholder="012 345 6789" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border">
                            </div>
                            <div class="sm:col-span-2">
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                <input type="email" name="email" id="email" value="<?php echo e(Auth::user()->email); ?>" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border">
                            </div>
                            <div class="sm:col-span-2">
                                <label for="address" class="block text-sm font-medium text-gray-700 mb-1">Địa chỉ</label>
                                <input type="text" name="address" id="address" value="<?php echo e(Auth::user()->address); ?>" placeholder="123 Bình Nguyên Vô Tận" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm px-4 py-3 border">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UIT\Phat_trien_ung_dung_web\DoAnWeb\webgym\resources\views/user/profile/profile.blade.php ENDPATH**/ ?>