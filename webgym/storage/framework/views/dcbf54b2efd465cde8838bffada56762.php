    ...
    <nav class="mt-2 space-y-1 px-2"> 
        ...
        <div class="relative group">
            ...
            <div id="lichlop-menu" class="hidden mt-1 ml-8 bg-white">
                <a href="<?php echo e(route('admin.class_schedule.index')); ?>" 
                ...
                <a href="<?php echo e(route('admin.class_list.index')); ?>" 
                class="flex items-center gap-2 px-3 py-2 w-full rounded-lg text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="relative">
            ...
            <div id="muondo-menu" class="hidden mt-1 ml-8 bg-white">
                <a href="<?php echo e(route('admin.rentals.index')); ?>" 
                class="flex items-center gap-2 px-3 py-2 w-full rounded-lg text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <a href="<?php echo e(route('admin.borrow_return.index')); ?>" 
                class="flex items-center gap-2 px-3 py-2 w-full rounded-lg text-gray-700 hover:bg-gray-100 hover:text-gray-900">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
</aside><?php /**PATH D:\UIT\Phat_trien_ung_dung_web\DoAnWeb\webgym\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>